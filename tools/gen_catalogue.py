...
"""
        ...
        html_content += f"""                </table>
                ...
                <a href="{download_url}" class="download-link" download>Download {font.filename}</a>
            </div>
"""
...
def main():
    ...
    font_files = glob.glob("fonts/*.bdf") or glob.glob("*.bdf")  # Check fonts/ first, fallback to root
